...
- Started (UTC): 2026-01-23T16:57:14
- Updated (UTC): 2026-01-23T16:57:50
- Duration: 00:00:35
- RPC endpoints: 4
- DEX adapters: 3
- Blocks scanned: 2
...
## Settings
```yaml
amount_presets: (10.0, 50.0, 100.0, 250.0, 500.0)
...
mempool_ws_urls: ('wss://ethereum-rpc.publicnode.com', 'wss://eth.merkle.io')
mev_buffer_bps: 0.0
...
rpc_urls: ('https://ethereum-rpc.publicnode.com', 'https://go.getblock.us', 'https://eth.merkle.io', 'https://rpc.flashbots.net')
scan_mode: auto
scan_source: hybrid
sim_backend: quote
slippage_bps: 0
...
trigger_prefer_cross_dex: False
